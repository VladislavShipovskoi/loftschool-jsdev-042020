    ...
    function treeTraversal(root) {
        root.childNodes.forEach(function (child) {
            if (child.nodeType === 3) {
                ...
                child.classList.forEach(function (classListElement) {
                    if (statsObj.classes[classListElement]) {
                        statsObj.classes[classListElement]++;
                    } else {
                        statsObj.classes[classListElement] = 1;
                    }
                });

                if (statsObj.tags[child.tagName]) {
                    statsObj.tags[child.tagName]++;
                } else {
                    statsObj.tags[child.tagName] = 1;
                }
